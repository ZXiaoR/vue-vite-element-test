...
const state: TagsViewTy = {
  ...
  const mutations = {
    ...
    UPDATE_VISITED_VIEW: (state: TagsViewTy, view:RouteItemTy) => {
  ...
  const actions = {
    ...
    delOthersViews({ dispatch, state }: ObjTy, view: any) {
      return new Promise(resolve => {
    ...
    delOthersVisitedViews({ commit, state }: ObjTy, view: any) {
      return new Promise(resolve => {
        commit('DEL_OTHERS_VISITED_VIEWS', view)
        resolve([...state.visitedViews])
      })
    },
    delOthersCachedViews({ commit, state }: ObjTy, view: any) {
      return new Promise(resolve => {
    ...
    delAllViews({ dispatch, state }: ObjTy, view: any) {
      return new Promise(resolve => {
    ...
    updateVisitedView({ commit }: ObjTy, view: any) {
